...
parser.add_argument('-no', '--naive-output', help='New IMGT archives per class in history. Option: no, yes',
                    default='no')
...
parser.add_argument('-uc', '--unique-count', help='input for the unique count', default='2')
...
parser.add_argument('-fa', '--fast', help='input fast process. input: yes, no', default='no')
